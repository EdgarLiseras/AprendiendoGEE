/*Instanciar una imagen con el constructor de imágenes, establecer las coordenadas y la ampliación del mapa, 
agregar un capa y colocar el mapa instanciado alli*/
...
es un proyecto internacional entre la Agencia Nacional de Inteligencia-Geoespacial, NGA, y 
la Administración Nacional de la Aeronáutica y del Espacio, NASA. Su fin es obtener un modelo digital de elevación 
(DEM Digital Model Elevation) de la zona del globo terráqueo entre 56 °S a 60 °N, de modo que genere una completa base de mapas 
topográficos digitales de alta resolución de la Tierra. Esta base cartográfica ha sido ampliamente utilizada en diferentes 
campos del conocimiento relacionados con la geomática al poderse descargar gratuitamente a través de Internet.*/
...
web (https://en.wikipedia.org/wiki/Web_colors). Los colores se pueden designar por su nombre o por cadenas exadecimales que indican 
el color.*/
